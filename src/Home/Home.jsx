...
const Home = () => {
 ...
 // hide toast msg
   ...
   const getUserInfo = async ()=>{
    try{
        const response=await axiosInstance.get("https://notesapp-backend-xh0o.onrender.com/get-user");
   ...
   const getAllNotes= async ()=>{
    try{
        const response= await axiosInstance.get("https://notesapp-backend-xh0o.onrender.com/get-all-notes");
   ...
   const deleteNote = async(data)=>{
    ...
    try {
        const response = await axiosInstance.delete(`https://notesapp-backend-xh0o.onrender.com/delete-note/${noteId}`);
...
const onSearchNote = async (query) => {
  try {
    const response = await axiosInstance.get("https://notesapp-backend-xh0o.onrender.com/search-notes", {
      params: { query },
    });
    if (response.data && response.data.notes) {
      setIsSearch(true);
   ...
   const updateIsPinned = async (noteData) => {
    ...
    try {
      const response = await axiosInstance.put(`https://notesapp-backend-xh0o.onrender.com/update-note-pinned/${noteId}`, {
